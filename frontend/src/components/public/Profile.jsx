    ...
    <>
      ...
      <div className="flex min-h-screen bg-gray-100 p-10 gap-6">
        <div className="w-1/4 flex flex-col space-y-4 mt-14 border-r border-gray-300 p-4">
          <button className="flex items-center gap-2 p-2 border bg-[#00bf63] text-white rounded-md w-full hover:bg-[#009f4e] transition">
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 p-2 w-full border border-gray-300 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-[#00bf63]"
                />
              </div>
              <div>
              ...
              <button
                ...
                className={`w-full p-3 rounded-md font-semibold text-white transition ${
                  isLoading ? 'bg-[#009f4e] cursor-not-allowed' : 'bg-[#00bf63] hover:bg-[#009f4e]'
                }`}
              >
